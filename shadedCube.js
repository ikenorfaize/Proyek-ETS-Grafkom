...
function init() {
    ...
    document.getElementById("Speed0_5x").onclick = function() { speedMultiplier = 0.5; };
    document.getElementById("Speed1x").onclick = function() { speedMultiplier = 1; };
    document.getElementById("Speed1_5x").onclick = function() { speedMultiplier = 1.5; };
    document.getElementById("Speed2x").onclick = function() { speedMultiplier = 2; };
